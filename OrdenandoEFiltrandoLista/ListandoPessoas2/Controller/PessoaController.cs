...
namespace ListandoPessoas2.Controller
{
    public class PessoaController
    {
        ...
        /// <summary>
        /// METODO PUBLICO QUE RETORNA A LISTA ORDENARDA PELA DATA DE NASCIMENTO DA MAIOR DATA PARA A MENOR DATA 
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// metodo que retorna a lsta de pessoas com idade maior         
        /// </summary>
        /// <param name="idade"> Idade que vamos usar para comparar </param>
        /// <returns> retorna a lista de pessoas pela idade informa</returns>
        ...
        /// <summary>
        /// Metodo que retorna idade menor que idade informada por parametro caso 
        /// parametro não informado o valor padrão é 16
        /// </summary>
