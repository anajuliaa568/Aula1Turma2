...
namespace ExercicioWhile
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Qual palavra você procura?:");
        ...
        /// <summary>
        /// Metodo de buscar a palavra função while 
        /// </summary>
